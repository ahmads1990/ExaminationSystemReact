...
export const AddExamModal = ({ show, onHide, onSuccess }: AddExamModalProps) => {
    ...
    const fetchCourses = async () => {
        ...
        try {
            // Fetch first page with a high limit to populate dropdown
        ...
        <Modal show={show} onHide={onHide} centered size="lg" backdrop="static">
            <Modal.Header className="border-0 pb-0 px-4 pt-4" closeButton>
                <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <Modal.Title className="fw-bold fs-5 mb-0">Create New Exam</Modal.Title>
                        <p className="text-muted small mb-0">Configure a new examination</p>
                    </div>
                </div>
            </Modal.Header>
                    ...
                    <Row className="g-3 mb-4 mt-1">
                        ...
                        <Col md={6}>
                            <Form.Check 
                                type="switch" 
                                id="results-switch" 
                                label={<span className="ms-2">Show Results Immediately</span>}
