...
import { Card, Row, Col, Form, Button, Nav, ListGroup, Badge, Dropdown } from "react-bootstrap";
import { User, Bell, Shield, Save, Sliders, KeyRound } from "lucide-react";
...
const formatTimezoneLabel = (tz: string) => {
    ...
    try {
        const offsetMinutes = new Date().toLocaleString("en-US", { timeZone: tz, timeZoneName: "longOffset" }).split("GMT")[1];
        if (offsetMinutes) {
                    ...
                    <Card className="border-0 shadow-sm rounded-4 bg-white overflow-hidden p-2">
                        <Nav className="flex-column nav-pills gap-1">
                            <Nav.Link 
                                ...
                                style={{ 
                                    backgroundColor: activeTab === "profile" ? "var(--color-primary-500)" : "transparent",
                            ...
                            <Nav.Link 
                                ...
                                className="d-flex align-items-center gap-3 px-3 py-2.5 rounded-3 border-0 text-start w-100"
                                style={{ 
                                    backgroundColor: activeTab === "notifications" ? "var(--color-primary-500)" : "transparent",
                            ...
                            <Nav.Link 
                                ...
                                className="d-flex align-items-center gap-3 px-3 py-2.5 rounded-3 border-0 text-start w-100"
                                style={{ 
                                    backgroundColor: activeTab === "security" ? "var(--color-primary-500)" : "transparent",
                            ...
                            <Nav.Link 
                                ...
                                className="d-flex align-items-center gap-3 px-3 py-2.5 rounded-3 border-0 text-start w-100"
                                style={{ 
                                    backgroundColor: activeTab === "preferences" ? "var(--color-primary-500)" : "transparent",
                            ...
                            <Form onSubmit={handleSaveProfile}>
                                ...
                                <div className="d-flex align-items-center gap-3 mb-4 p-3 bg-light rounded-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-secondary small text-capitalize">{role.toLowerCase()} Account</div>
                                    </div>
                                </div>
                                            ...
                                            <div className="input-group">
                                                <Dropdown onSelect={(key) => setCountryCode(key || "+1")}>
                                                    <Dropdown.Toggle 
                                                        ...
                                                        style={{ borderTopLeftRadius: "8px", borderBottomLeftRadius: "8px", borderTopRightRadius: 0, borderBottomRightRadius: 0 }}
                                                    >
                                                        <img 
                                                    ...
                                                    <Dropdown.Menu style={{ maxHeight: "250px", overflowY: "auto" }}>
                                                        {countries.map((c) => (
                                                            <Dropdown.Item key={c.code} eventKey={c.code} className="d-flex align-items-center gap-2">
                                                                <img 
                                ...
                                <Button type="submit" className="d-flex align-items-center gap-2 rounded-3 px-4 py-2 border-0 bg-primary shadow-sm hover-bg-primary-dark">
                                ...
                                <div className="d-flex flex-column gap-3 mb-4">
                                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light-subtle">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Receive notifications of important changes via email.</div>
                                        </div>
                                        <Form.Check 
                                            type="switch" 
                                    ...
                                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light-subtle">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Play sounds and display alerts inside the browser.</div>
                                        </div>
                                        <Form.Check 
                                            type="switch" 
                                    ...
                                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light-subtle">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Notify me 24 hours before any scheduled exam opens.</div>
                                        </div>
                                        <Form.Check 
                                            type="switch" 
                                            id="reminders-switch"
                                    ...
                                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light-subtle">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Receive urgent low-timer or deadline alerts via text message.</div>
                                        </div>
                                        <Form.Check 
                                            type="switch" 
                                    ...
                                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light-subtle">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Play a subtle tick sound during the final 5 minutes of exams.</div>
                                        </div>
                                        <Form.Check 
                                            type="switch" 
                                    ...
                                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light-subtle">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Receive weekly progress summaries and statistics.</div>
                                        </div>
                                        <Form.Check 
                                            type="switch" 
                                            id="digest-switch"
                                ...
                                <div className="mb-4 d-flex flex-column gap-3">
                                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light-subtle">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Protect your exam workspace with an additional device validation lock.</div>
                                        </div>
                                        <Form.Check 
                                            type="switch" 
                                            id="mfa-switch"
                                    ...
                                    <div className="p-3 border rounded-3 bg-light-subtle d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <div className="text-secondary small">Keep your account secure by updating your secret key password regularly.</div>
                                        </div>
                                        <Link to="/change-password" className="btn btn-outline-secondary btn-sm rounded-2 px-3 py-1.5 fw-semibold d-flex align-items-center gap-1 text-decoration-none">
                                ...
                                <div className="mb-4">
                                    ...
                                    <ListGroup className="rounded-3 border border-light overflow-hidden">
                                        <ListGroup.Item className="d-flex justify-content-between align-items-center p-3 small text-secondary bg-white">
                                            <div>
                                                <div className="fw-semibold text-dark">Chrome on Windows (Boston, USA)</div>
                                        ...
                                        <ListGroup.Item className="d-flex justify-content-between align-items-center p-3 small text-secondary bg-white">
                                            <div>
                                                <div className="fw-semibold text-dark">Safari on iPhone (New York, USA)</div>
                                                <div className="text-muted small">July 14, 2026 - 11:05 AM</div>
                                            </div>
                                            <Button variant="link" className="p-0 text-danger text-decoration-none small" onClick={() => toast.success("Session revoked.")}>Revoke</Button>
                                        </ListGroup.Item>
                                    </ListGroup>
                                    <div className="mt-3 text-end">
                                        <Button variant="outline-danger" size="sm" className="rounded-2 fw-semibold px-3" onClick={() => toast.success("All other active sessions revoked.")}>
                        ...
                        {activeTab === "preferences" && (
                            <Form onSubmit={handleSavePreferences}>
                                ...
                                <Row className="g-3 mb-4">
                                        ...
                                        <Form.Group className="mb-3">
                                            ...
                                            <Dropdown onSelect={(key) => setLanguage(key || "en")} className="w-100">
                                                ...
                                                <Dropdown.Menu className="w-100">
                                                    {languagesList.map((l) => (
                                                        <Dropdown.Item key={l.code} eventKey={l.code} className="d-flex align-items-center gap-2">
                                                            <img 
                                    ...
                                    <Col xs={12}>
                                        <Form.Group className="mb-3">
                                            <Form.Label className="fw-semibold text-secondary">Default Font Size</Form.Label>
