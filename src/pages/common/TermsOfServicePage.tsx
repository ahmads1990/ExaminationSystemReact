            ...
            <Card className="border-0 shadow-sm rounded-4 bg-white p-5">
                ...
                <div className="text-secondary d-flex flex-column gap-4" style={{ lineHeight: 1.6 }}>
                    <section>
                        ...
                        <p>
                            By accessing and using the ExamSys examination system, you agree to comply with and be bound
                    ...
                    <section>
                        ...
                        <p>
                            All examinations conducted through this platform are subject to strict academic integrity
                            policies. Any attempt to cheat, share answers, utilize unauthorized materials, or bypass the
                            application's environment will result in immediate disqualification and disciplinary action.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            immediately of any unauthorized use of your account. ExamSys will not be held liable for any
                            loss arising from unauthorized account access.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            without prior notice, if we believe you are in breach of these Terms of Service.
                        </p>
                    </section>
                </div>
            </Card>
