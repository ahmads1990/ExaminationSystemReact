                    ...
                    <div className="d-flex flex-column flex-md-row align-items-center align-items-md-end gap-3" style={{ marginTop: "-60px" }}>
                        ...
                        <div className="flex-grow-1 text-center text-md-start mb-2">
                            ...
                            <p className="text-secondary mb-0 d-flex flex-wrap align-items-center justify-content-center justify-content-md-start gap-2">
                                ...
                                <Badge bg="success" className="text-uppercase py-1.5 px-2.5 rounded-pill" style={{ fontSize: "0.75rem" }}>
                                    {userProfile.roleLabel}
                                </Badge>
                            </p>
                        </div>
                        <div className="mb-2">
                            <Link to="/settings" className="btn btn-outline-secondary btn-sm rounded-3 px-3 py-2 fw-semibold d-flex align-items-center gap-2">
                    ...
                    <Card className="border-0 shadow-sm rounded-4 bg-white p-4 h-100">
                        ...
                        <div className="d-flex flex-column gap-3">
                            <div className="d-flex align-items-center gap-3 p-2 bg-light-subtle rounded-3">
                                ...
                                <div>
                                    <div className="text-muted small" style={{ fontSize: "0.75rem" }}>Phone Number</div>
                            ...
                            <div className="d-flex align-items-center gap-3 p-2 bg-light-subtle rounded-3">
                                ...
                                <div>
                                    <div className="text-muted small" style={{ fontSize: "0.75rem" }}>Timezone</div>
                            ...
                            <div className="d-flex align-items-center gap-3 p-2 bg-light-subtle rounded-3">
                                ...
                                <div>
                                    <div className="text-muted small" style={{ fontSize: "0.75rem" }}>Status</div>
                    ...
                    <Card className="border-0 shadow-sm rounded-4 bg-white p-4 h-100">
                        {isInstructor ? (
                            <>
                                ...
                                <p className="text-secondary small mb-4">A snapshot of courses and items you administer on this platform.</p>
                                ...
                                <ListGroup className="rounded-3 border border-light overflow-hidden mb-3">
                                    <ListGroup.Item className="d-flex justify-content-between align-items-center p-3 bg-white">
                                        <div>
                                            <div className="fw-semibold text-dark small">CS-101: Introduction to Computing</div>
                                    ...
                                    <ListGroup.Item className="d-flex justify-content-between align-items-center p-3 bg-white">
                                        <div>
                                            <div className="fw-semibold text-dark small">CS-302: Database Management Systems</div>
                                ...
                                <div className="bg-light p-3 rounded-3 d-flex align-items-center justify-content-between">
                                    ...
                                    <Link to="/instructor/exams" className="btn btn-primary btn-sm rounded-2 fw-semibold px-3 py-1.5">
                                        Manage Exams
                                    </Link>
                                </div>
                            </>
                            ...
                            <>
                                ...
                                <p className="text-secondary small mb-4">Your current enrolled classes and examination achievements.</p>

                                <ListGroup className="rounded-3 border border-light overflow-hidden mb-3">
                                    <ListGroup.Item className="d-flex justify-content-between align-items-center p-3 bg-white">
                                        <div>
                                            <div className="fw-semibold text-dark small">Introduction to Machine Learning</div>
                                            <div className="text-muted small">Last Test: Grade A (94%)</div>
                                        </div>
                                        <Badge bg="success" pill>Enrolled</Badge>
                                    </ListGroup.Item>
                                    <ListGroup.Item className="d-flex justify-content-between align-items-center p-3 bg-white">
                                        <div>
                                            <div className="fw-semibold text-dark small">Data Structures & Algorithms</div>
                                ...
                                <div className="bg-light p-3 rounded-3 d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <span className="text-secondary small">CS-202 Quiz 3 is scheduled next week.</span>
                                    </div>
                                    <Link to="/student/calendar" className="btn btn-success btn-sm rounded-2 fw-semibold px-3 py-1.5">
                                        View Calendar
                                    </Link>
                                </div>
                            </>
